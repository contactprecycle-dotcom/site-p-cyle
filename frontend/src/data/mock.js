...
export const detailedPricing = {
  transmission: [
    ...
    { service: "Changement câbles + gaines (passage interne)", price: "30€" },
    { service: "Changement de chaîne", price: "17€" },
    { service: "Changement cassette / roue libre / plateau", price: "15€" },
    { service: "Changement manette (câble, gaine, réglage)", price: "30€" },
    { service: "Changement manette (passage interne)", price: "40€" },
    { service: "Remplacement patte de dérailleur", price: "30€" },
    { service: "Changement pédalier", price: "25€" },
  ...
  wheels: [
    ...
    { service: "Changement pneu", price: "20€" },
    { service: "Changement pneu (moteur/tambour/nexus)", price: "25€" },
    { service: "Dévoilage de roue", price: "15€" },
    { service: "Dévoilage roue - écrous internes", price: "40€" },
    { service: "Changement de roue", price: "30€" },
    { service: "Changement roue (moteur/tambour/nexus)", price: "35€" },
    { service: "Graissage roulement avant", price: "25€" },
    { service: "Graissage roulement arrière", price: "30€" },
  ...
  braking: [
    ...
    { service: "Changement patins/plaquettes (paire)", price: "20€" },
    { service: "Changement câble et gaine frein", price: "20€" },
    { service: "Changement câble et gaine (passage interne)", price: "30€" },
  ...
  accessories: [
    ...
    { service: "Remplacement guidoline", price: "20€" },
